...
<div className="flex flex-col col-span-3 mx-auto mt-5">
    ...
    <div className="flex items-center border-b mb-4">
        ...
        <input min={1} value = {numberOfGuest} onChange={(e) => setNumberOfGuest(e.target.value)}className="w-12 pl-2 text-lg outline-none text-red-400" type="number" />
